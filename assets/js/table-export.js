var TableExport = function() {
	...
	var runTableExportTools = function() {
		$(".export-pdf").on("click", function(e) {
			...
			var content = $(exportTable).html();
			var baseUrl = $("#rootPath").val();
			var Url = $("#rootPath").val()+'admin/detailed_report/generatePdfReport'; 
			var file_name =  $(this).data("export-name");
			$.post(Url, {data: content, file_name: file_name}, function(resposnce){
				if(resposnce == 'true'){
					var redirectUrl = baseUrl + "assets/files/reports/"+ file_name+'.pdf';
