/*-----------------------------------------------------------------------------------
    ...
    Theme Name: Vimacopter | Soaring to New Heights
    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logoinner.attr('src', 'assets/website/img/logos/logo.png');
                logodefault.attr('src', 'assets/website/img/logos/logo.png');
                logowhite.attr('src', 'assets/website/img/logos/logo-white.png');
                logowhitedark.attr('src', 'assets/website/img/logos/logo-white.png');
                logo2.attr('src', 'assets/website/img/logos/logo-2-light.png');
                logo4.attr('src', 'assets/website/img/logos/logo-4.png');
                logo5.attr('src', 'assets/website/img/logos/logo-5-light.png');
                logo6.attr('src', 'assets/website/img/logos/logo-6.png');
                logo7.attr('src', 'assets/website/img/logos/logo-7.png');
                logo8.attr('src', 'assets/website/img/logos/logo-8.png');
            } 
            else {
                ...
                logodefault.attr('src', 'assets/website/img/logos/logo.png');
                logowhite.attr('src', 'assets/website/img/logos/logo-white.png');
                logowhitedark.attr('src', 'assets/website/img/logos/logo-dark.png');
                logo2.attr('src', 'assets/website/img/logos/logo-2-dark.png');
                logo4.attr('src', 'assets/website/img/logos/logo-4.png');
                logo5.attr('src', 'assets/website/img/logos/logo-5-dark.png');
                logo6.attr('src', 'assets/website/img/logos/logo-6.png');
                logo7.attr('src', 'assets/website/img/logos/logo-7.png');
                logo8.attr('src', 'assets/website/img/logos/logo-8.png');
            }
