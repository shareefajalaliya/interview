...
class Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $this->_ci->load->config('ssl');
        $this->_siteKey = $this->_ci->config->item('site_key','recaptcha');
        $this->_secretKey = $this->_ci->config->item('secret_key','recaptcha');
        $this->_language = $this->_ci->config->item('lang','recaptcha');
