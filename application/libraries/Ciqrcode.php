...
class Ciqrcode
{
	...
	function __construct($config = array()) {
		require APPPATH .'third_party/qrcode/qrconst.php';
		require APPPATH .'third_party/qrcode/qrtools.php';
		require APPPATH .'third_party/qrcode/qrspec.php';
		require APPPATH .'third_party/qrcode/qrimage.php';
		require APPPATH .'third_party/qrcode/qrinput.php';
		require APPPATH .'third_party/qrcode/qrbitstream.php';
		require APPPATH .'third_party/qrcode/qrsplit.php';
		require APPPATH .'third_party/qrcode/qrrscode.php';
		require APPPATH .'third_party/qrcode/qrmask.php';
		require APPPATH .'third_party/qrcode/qrencode.php';
