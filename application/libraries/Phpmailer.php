...
class Phpmailer extends CI_PHPMailer {

    function __construct() {
        parent::__construct();
    }

    public function send_mail($mail_from, $mail_to, $mail_reply_to, $mail_subject, $mail_body, $mail_altbody, $mail_type = "mail", $smtp_data = array(), $attachments = array()) {
